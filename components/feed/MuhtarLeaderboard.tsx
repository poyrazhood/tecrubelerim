...
const RANK_STYLES = {
  1: { bg: 'from-amber-400 to-yellow-600', text: 'text-black', label: '🥇' },
  2: { bg: 'from-slate-300 to-slate-400', text: 'text-black', label: '🥈' },
  3: { bg: 'from-amber-700 to-amber-800', text: 'text-white', label: '🥉' },
}
...
export function MuhtarLeaderboard({ muhtarlar }: MuhtarLeaderboardProps) {
  return (
    <div className="rounded-2xl border border-white/[0.06] bg-surface-1 p-4 mb-4">
      ...
      <p className="text-xs text-white/40 mb-4">En güvenilir ve faydalı yorumcular</p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-white/40 truncate">
                  {muhtar.neighborhood} · {muhtar.expertise[0]}
                </div>
              </div>
